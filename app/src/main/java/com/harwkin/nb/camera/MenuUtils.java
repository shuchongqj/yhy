...
//    public static Dialog showMenu(final Context context, final int choosedItem,
//            final String[] items,final OnMenuPickLisener lsn) {
...
//        MenuAdapter adapter = new MenuAdapter(context, items,choosedItem);

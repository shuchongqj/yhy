...
import com.harwkin.nb.camera.options.DefaultOptions;
...
public class PhotoUtil {
    ...
    public static Bitmap getPhoto(CameraOptions build) {
        ...
        int imageWidth =build.getImageWidthCompress();
        int imageHeight = build.getImageHeightCompress();

        return rotateBitmap(getThenumBitmap(build, imageWidth==0?IMAGE_WIDTH:imageWidth, imageHeight==0?IMAGE_HEIGHT:imageHeight),
    ...
    public static String depositInDiskBitmap(Context context, Bitmap compressImage) {
        ...
        buffer.append(MD5Utils.toMD5(System.currentTimeMillis() + ".jpg"));
        try {
    ...
    public static String depositInDiskGif(Context context, String str, String format) {
    ...
    public static void depositInDisk(Bitmap compressImage,
        ...
        while (baos.toByteArray().length / 1024 >= 1024) {
            if (quality >= 50) {
                baos.reset();
                quality -= 5;
                compressImage.compress(Bitmap.CompressFormat.JPEG, quality, baos);
            } else {
                break;
            }
        }

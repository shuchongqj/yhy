...
import com.harwkin.nb.camera.IMThumbnailsPhoto;
import com.harwkin.nb.camera.PhotoUri;
...
public class CameraOptions implements Serializable {
    ...
    //拍照时候是否压缩上传
    private boolean isNeedCameraCompress = true;
    ...
    public boolean isNeedCameraCompress() {
        return isNeedCameraCompress;
    }

    public void setNeedCameraCompress(boolean needCameraCompress) {
        isNeedCameraCompress = needCameraCompress;
    }



    public int getImageWidthCompress() {
        return imageWidth;
    }

    public void setImageWidthCompress(int imageWidth) {
       this. imageWidth = imageWidth;
    }

    public int getImageHeightCompress() {
        return imageHeight;
    }

    public void setImageHeightCompress(int imageHeight) {

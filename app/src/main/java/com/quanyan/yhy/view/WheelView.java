...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.DateWheelView, 0, R.style.WheelView);
        boolean cyclic = a.getBoolean(R.styleable.DateWheelView_cyclic, false);
        int visibleItems = a.getInt(R.styleable.DateWheelView_visibleItems, mVisibleItems);
        int lineSpace = a.getDimensionPixelOffset(R.styleable.DateWheelView_lineSpace, mLineSpace);
        int textSize = a.getDimensionPixelSize(R.styleable.DateWheelView_wheeltextSize, mTextSize);
        int selectedColor = a.getColor(R.styleable.DateWheelView_wheel_selectedColor, 0);
        int unselectedColor = a.getColor(R.styleable.DateWheelView_wheel_unselectedColor, 0);
        mDividerTop = a.getDrawable(R.styleable.DateWheelView_divider);
        mDividerBottom = a.getDrawable(R.styleable.DateWheelView_divider);
        CharSequence[] entries = a.getTextArray(R.styleable.DateWheelView_entries);
        a.recycle();

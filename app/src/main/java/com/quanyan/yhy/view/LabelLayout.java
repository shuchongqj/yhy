...
public class LabelLayout extends ViewGroup {
	...
	public LabelLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.FlowLayoutL_Layout, defStyle, 0);

		try {
			int index = a.getInt(R.styleable.FlowLayoutL_Layout_android_layout_gravity, -1);
			if(index > 0) {
				setGravity(index);
			}
		} finally {
	...
	public static class LayoutParams extends MarginLayoutParams {
		...
		public LayoutParams(Context c, AttributeSet attrs) {
			...
			TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.FlowLayoutL_Layout);

			try {
				gravity = a.getInt(R.styleable.FlowLayoutL_Layout_android_layout_gravity, -1);
			} finally {
				a.recycle();
			}
		}

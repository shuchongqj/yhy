...
public class SysConfigType {
    ...
    //首页弹窗广告页
    public static final String MULTI_AD = "MULTI_AD";
    // 打点长度
    ...
    public static final String URL_OUT_VENUE_DETAIL = "URL_OUT_VENUE_DETAIL";
    public static final String URL_RECOMMEND_VENUE = "URL_RECOMMEND_VENUE";
    public static final String URL_NEW_RECOMMEND_VENUE = "URL_NEW_RECOMMEND_VENUE";
    ...
    // 运动配置8个按钮 “更多”跳转的H5地址
    public static final String URL_SPORT_YYW_MORE = "URL_SPORT_YYW_MORE";

    //培训主页
    public static final String URL_TRAIN_HOME = "URL_TRAIN_HOME";

    //课程详情 URL_TRAIN_COURSE_DETAIL
    public static final String URL_TRAIN_COURSE_DETAIL = "URL_TRAIN_COURSE_DETAIL";

    //课程列表 URL_TRAIN_COURSE_LIST
    public static final String URL_TRAIN_COURSE_LIST = "URL_TRAIN_COURSE_LIST";

    //机构详情
    public static final String URL_ORG_DETAIL = "URL_ORG_DETAIL";

    //机构列表
    public static final String URL_ORG_LIST = "URL_ORG_LIST";

    //约战广场
    public static final String URL_WAR_SQUARE = "URL_WAR_SQUARE";

    //约战详情
    public static final String URL_WAR_ID = "URL_WAR_ID";

    //应战
    public static final String URL_CONFIRM_WAR = "URL_CONFIRM_WAR";

    // 购物车列表
    public static final String SHOPCART_LIST = "SHOPCART_LIST";

    // 查看积分明细
    public static final String VIEW_INTEGRAL_DETAIL = "VIEW_INTEGRAL_DETAIL";

    // 查看积分任务列表
    public static final String VIEW_INTEGRAL_TASK_LIST = "VIEW_INTEGRAL_TASK_LIST";

    // 积分商品订单详情
    public static final String POINT_ORDER_DETAIL = "POINT_ORDER_DETAIL";

    // 文章详情
    public static final String URL_QUANZI_ARTICLE = "URL_QUANZI_ARTICLE";

    // 短视频详情
    public static final String URL_SHORT_VIDEO = "URL_SHORT_VIDEO";
}

...
package com.quanyan.yhy.ui.views.birthdaychoose;
...
public class WheelView extends View {
	...
	/** 当前值与标签文本颜色 */
	private static final int VALUE_TEXT_COLOR = 0xFFFA4619;

	/** 项目文本颜色 */
	private static final int ITEMS_TEXT_COLOR = 0xFF888888;

	/** 顶部和底部的阴影颜色 */
	private static final int[] SHADOWS_COLORS = new int[] { 0xFF8C00,
			0xFF8C00, 0xFF8C00 };
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(ScreenSize.dp2px(getContext(),TEXT_SIZE));
		}

		if (valuePaint == null) {
			valuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG| Paint.FAKE_BOLD_TEXT_FLAG | Paint.DITHER_FLAG);
			valuePaint.density = getResources().getDisplayMetrics().density;
			valuePaint.setTextSize(ScreenSize.dp2px(getContext(),TEXT_SIZE));
...
//		canvas.drawRect(0, center + offset, getWidth(), getHeight(), paint);
		paint.setColor(Color.parseColor("#FA4619"));

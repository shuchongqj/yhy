...
import com.quanyan.yhy.ui.wallet.view.gridpasswordview.imebugfixer.ImeDelBugFixedEditText;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (textSize != -1) {
            this.mTextSize = GridPassWordUtil.px2sp(context, textSize);
        }

        mLineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_gpvLineWidth, GridPassWordUtil.dp2px(getContext(), 1));
    ...
    private void inflaterViews(Context context) {
        ...
        while (index < mPasswordLength) {
            ...
            TextView textView = (TextView) inflater.inflate(R.layout.grid_textview, null);
    ...
    public void forceInputViewGetFocus(int type) {
            ...
            timer.schedule(new TimerTask() {
                ...
                public void run() {
                    InputMethodManager m = (InputMethodManager)
                            mInputView.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);

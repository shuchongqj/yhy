package com.quanyan.yhy.ui.shortvideo.view;
...
//
				...
				if (hasNext) {
//					System.out.println("wjm===hasNext="+hasNext);
		...
		// 画三秒
		if (duration < 5000) {
			left = (int) (5000F / mMaxDuration * width);
...
//		}
	...
	public void stopMedia(ImageView mTitleNext) {
		this.mTitleNext = mTitleNext;
	}

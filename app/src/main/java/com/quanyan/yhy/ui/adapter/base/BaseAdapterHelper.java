...
public class BaseAdapterHelper {
    ...
    protected BaseAdapterHelper(Context context, ViewGroup parent, int layoutId, int position) {
        ...
        convertView.setTag(R.string.app_name, this);
    }
    ...
    public static BaseAdapterHelper get(Context context, View convertView, ViewGroup parent, int layoutId, int position) {
        ...
        if (existingHelper == null || existingHelper.layoutId != layoutId) {
            return new BaseAdapterHelper(context, parent, layoutId, position);
        }
    ...
    public BaseAdapterHelper setFlags(int viewId, int flag) {
        TextView view = retrieveView(viewId);
    ...
    /**
     * Will set the image of an ImageView's LayoutParams from a resource id.
     *
     * @param viewId       The view id.
     * @param layoutParams The layoutParams
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setLinearLayoutParams(int viewId, LinearLayout.LayoutParams layoutParams) {
        ImageView view = retrieveView(viewId);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setRelativeLayoutParams(int viewId, RelativeLayout.LayoutParams layoutParams) {
        ImageView view = retrieveView(viewId);
        view.setLayoutParams(layoutParams);
        return this;
    }
    ...
    public BaseAdapterHelper setTextEnable(int viewId, boolean clickable) {
        TextView view = retrieveView(viewId);
...
//    public BaseAdapterHelper setImageUrlCorner(int viewId, String imageUrl, int width, int height, int defaultPic, int corner) {
//        ImageView view = retrieveView(viewId);
...
//    }
    ...
    public BaseAdapterHelper setImageUrl(int viewId, String imageUrl, int width, int height, int defaultPic) {
        ImageView view = retrieveView(viewId);
        if (!TextUtils.isEmpty(imageUrl)) {
...
//            Glide.with(context).load(imageUrl).into(view);
     ...
     * @return
     */
    public BaseAdapterHelper setFrescoImageUrl(int viewId, String imageUrl, int width, int height, int defaultPic) {
        ImageView view = retrieveView(viewId);
        if (!TextUtils.isEmpty(imageUrl)) {
//            BaseImgView.frescoLoadimg(view,
//                    imageUrl,
//                    defaultPic,
//                    defaultPic,
//                    defaultPic,
...
//                    0);
     ...
     * @return
     */
    public BaseAdapterHelper setHeaderIcon(int viewId, String imageUrl, String type, int width, int height) {
        ImageView view = retrieveView(viewId);
        int defaultPic = MerchantType.TALENT.equals(type) ? R.mipmap.icon_default_avatar : R.mipmap.ic_shop_default_logo;
        if (!TextUtils.isEmpty(imageUrl)) {
//            BaseImgView.loadimg(view,
//                    imageUrl,
//                    defaultPic,
...
//                    180);
            ...
            ImageLoadManager.loadCircleImage(CommonUtil.getImageFullUrl(imageUrl), defaultPic, width, height, view);
    ...
    public BaseAdapterHelper setImageUrlRound(int viewId, String imageUrl, int width, int height, int defaultPic) {
        ImageView view = retrieveView(viewId);
        if (!TextUtils.isEmpty(imageUrl)) {
//            BaseImgView.loadimg(view,
//                    imageUrl,
...
//                    180);
    ...
    public BaseAdapterHelper setFrescoImageUrlRound(int viewId, String imageUrl, int width, int height, int defaultPic) {
        ImageView view = retrieveView(viewId);
        if (!TextUtils.isEmpty(imageUrl)) {
//            BaseImgView.frescoLoadimg(view,
//                    imageUrl,
...
//                    180);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setVisibleOrInVisible(int viewId, boolean visible) {
        View view = retrieveView(viewId);
    ...
    public BaseAdapterHelper setSecondaryProgres(int viewId, int progress) {
        ProgressBar view = retrieveView(viewId);

...
public class CancelFollowPopView extends PopupWindow {
    ...
    public CancelFollowPopView(Context context, View.OnClickListener onClickListener){
        ...
        final View view = View.inflate(context, R.layout.dialog_cancel_follow_choice, null);
        view.findViewById(R.id.dialog_canel_follow).setOnClickListener(onClickListener);

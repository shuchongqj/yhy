...
package com.quanyan.yhy.ui.common.calendar.lib;
...
//                R.mipmap.calendar_bg_selector);
    ...
    /**
     * This method should only be called if the calendar is contained in a InterestMultiPageDialog, and it should only
     * be called once, right after the InterestMultiPageDialog is shown (using
    ...
    public void fixDialogDimens() {
        ...
        // Fix the layout height/width after the InterestMultiPageDialog has been shown.
    ...
    /**
     * This method should only be called if the calendar is contained in a InterestMultiPageDialog, and it should only
     * be called when the screen has been rotated and the InterestMultiPageDialog should be re-measured.
     */

...
import com.quanyan.yhy.ui.servicerelease.helper.ClickableImageSpan;
 ...
 * Title:PictureAndTextEditorView
 * Description:
...
public class PictureAndTextEditorView extends EditText {
    ...
    public static final String mBitmapTagStart = "<img src=\"";
    public static final String mBitmapTagEnd = "\"/>";
    ...
    private SpannableString insertBitmap(String path, Bitmap bitmap) {
        ...
        ClickableImageSpan imageSpan = new ClickableImageSpan(mContext, bitmap) {
            @Override
            public void onClick(View view) {
                if(mOnPictureClickListener != null){
                    mOnPictureClickListener.onPictureClick(index);
                }
        ...
        //spannableString.setSpan(new MyClickableSpan(path, spannableString), 0, path.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    private SpannableString replaceBitmap(String srcPath, String desPath, Bitmap bitmap){
        Editable edit_text = getEditableText();
        final int index = getSelectionStart(); // 获取光标所在位置
        return null;
    }
    ...
    public void setOnPictureClickListener(OnPictureClickListener lsn) {
        this.mOnPictureClickListener = lsn;
    }

    public interface OnPictureClickListener {
        void onPictureClick(int index);
    }

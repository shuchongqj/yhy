...
public class ImImageLoader {
    ...
    /**
     * Creates a new ImageLoader that is backed by an {@link org.akita.cache.FilesCache< Bitmap>}. The cache will by default
     * cache to the device's external storage, and expire images after 1 day. You can set useCache
     * to false and then supply your own remoteimageview cache instance via {@link #setImageCache(org.akita.cache.FilesCache< Bitmap>)}
     * , or fine-tune the default one through {@link #getImageCache()}.
     *
     * @param context
     *            the current context
     * @param createCache
     *            whether to create a default {@link org.akita.cache.FilesCache< Bitmap>} used for caching
     */
    public ImImageLoader(Context context, boolean createCache) {
        ...
        errorBgRes = ImImageView.DEFAULT_ERROR_DRAWABLE_RES_ID;
     ...
     *
     * @return the {@link org.akita.cache.FilesCache< Bitmap>}
     */
     ...
     * {@link org.akita.widget.remoteimageview.RemoteImageLoaderHandler} to process the bitmap after downloading it.
     *
     * @param imageUrl
    ...
    public void loadImage(String imageUrl, String httpReferer, boolean noCache, ProgressBar progressBar,
                          ImageView imageView) {
        loadImage(imageUrl, httpReferer, noCache, progressBar, imageView, defaultBgRes, new ImImageLoaderHandler(
     ...
     */
    public void loadImage(String imageUrl, String httpReferer, boolean noCache, ProgressBar progressBar,
                          ImageView imageView, ImImageLoaderHandler handler) {
    ...
    public void loadImage(String imageUrl, String httpReferer, boolean noCache, ProgressBar progressBar, ImageView imageView,
                          int defaultBgRes, ImImageLoaderHandler handler) {
        if (imageView != null) {
            if (imageUrl == null) {
        ...
        if (noCache) {
            ...
            executor.execute(new ImImageLoaderJob(imageUrl, httpReferer, progressBar, handler,
                    null));

...
public class Pedometer {
    public static final float DEFAUL_HEIGHT = 175;
    public static final float DEFAUL_WEIGHT = 65;
    ...
    private float mHeight = DEFAUL_HEIGHT;//cm
    private float mWeight = DEFAUL_WEIGHT;//kg
    private int mAge = DEFAUL_AGE;//age
...
//    }
    ...
    public boolean isDetectorRegistered(Context context) {
        boolean result = context.getSharedPreferences(Constants.SP_SETTING_NAME, Context.MODE_PRIVATE)
                .getBoolean(Constants.SP_SETTING_ITEM_KEY, false);

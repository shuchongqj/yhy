    ...
    public void acquireWakeLock(Context paramContext) {
        try {
            ...
            if ((this.wakeLock_ == null) && (ON)) {
                this.wakeLock_ = ((PowerManager) paramContext.getSystemService(Service.POWER_SERVICE))
                        .newWakeLock(PowerManager.PARTIAL_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "Pedometer step keep partial wakelock");

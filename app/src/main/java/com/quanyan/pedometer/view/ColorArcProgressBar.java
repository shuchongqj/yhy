...
public class ColorArcProgressBar extends View {
    ...
    private String hintColor = "#666666";
    private String titleColor = "#666666";
    ...
    public ColorArcProgressBar(Context context) {
        super(context, null);
        bgArcColor = getResources().getColor(R.color.neu_f4f4f4);
        initView();
    }
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        int color1 = typedArray.getColor(R.styleable.ColorArcProgressBar_front_color1, Color.YELLOW);
        int color2 = typedArray.getColor(R.styleable.ColorArcProgressBar_front_color2, Color.RED);
        colors = new int[]{color1, color1, color1, color1, color2, color2, color2,color1};

        mStartAngle = typedArray.getInteger(R.styleable.ColorArcProgressBar_start_sweep_angle, 0);
        bgArcColor = typedArray.getColor(R.styleable.ColorArcProgressBar_back_color, bgArcColor);
        mTotalAngle = typedArray.getInteger(R.styleable.ColorArcProgressBar_total_angle, 270);
        bgArcWidth = typedArray.getDimension(R.styleable.ColorArcProgressBar_back_width, dipToPx(2));
        progressWidth = typedArray.getDimension(R.styleable.ColorArcProgressBar_front_width, dipToPx(10));
        ...
        hintString = typedArray.getString(R.styleable.ColorArcProgressBar_string_unit);
        titleString = typedArray.getString(R.styleable.ColorArcProgressBar_string_title);
        curValues = typedArray.getFloat(R.styleable.ColorArcProgressBar_current_value, 0);
        maxValues = typedArray.getFloat(R.styleable.ColorArcProgressBar_max_value, 60);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //整个弧
        canvas.drawArc(bgRect, mStartAngle, mTotalAngle, false, allArcPaint);

        //设置渐变色
        rotateMatrix.setRotate(mStartAngle, centerX, centerY);
        ...
        if(!TextUtils.isEmpty(mNoticeText)){
            canvas.drawText(mNoticeText, centerX, centerY + textSize / 3, vTextPaint);
        }else{
            if (isNeedContent) {
        ...
        if (isNeedTitle) {
            canvas.drawText(titleString, centerX, centerY - 2 * textSize / 3 - 20, curSpeedPaint);
        }

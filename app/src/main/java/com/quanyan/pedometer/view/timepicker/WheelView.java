package com.quanyan.pedometer.view.timepicker;
...
import com.quanyan.pedometer.view.timepicker.adapter.WheelAdapter;
import com.quanyan.pedometer.view.timepicker.scroll.ScrollableView;
import com.quanyan.pedometer.view.timepicker.scroll.Step;
import com.quanyan.pedometer.view.timepicker.utils.WindowUtil;
...
public class WheelView extends ScrollableView implements OnClickListener {
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.wheelpedometer);
        int textColorFirst = a.getColor(R.styleable.wheelpedometer_textColorFirstpedometer, -1);
        int textColorSecond = a.getColor(R.styleable.wheelpedometer_textColorSecondpedometer, -1);
        int textColorThird = a.getColor(R.styleable.wheelpedometer_textColorThirdpedometer, -1);
        this.textSize = a.getDimension(R.styleable.wheelpedometer_textSizepedometer, -1);
        this.textSize = WindowUtil.computeScaledSize(getContext(),textSize);
        int lineColor = a.getColor(R.styleable.wheelpedometer_splitLineColorpedometer, -1);
        this.lineSplitHeight = a.getDimension(R.styleable.wheelpedometer_lineSplitHeightpedometer, -1);
        this.lineSplitHeight = WindowUtil.computeScaledSize(getContext(), this.lineSplitHeight);
        this.itemHeight = this.textSize + this.lineSplitHeight;
        this.textGravity = a.getInt(R.styleable.wheelpedometer_textGravitypedometer, -1);
        a.recycle();

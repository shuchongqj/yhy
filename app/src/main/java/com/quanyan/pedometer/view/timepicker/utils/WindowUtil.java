package com.quanyan.pedometer.view.timepicker.utils;
...
//    {
//    	return HMApplication.getContext();
//    }
    ...
    public static boolean setWidth(View view, int designedWidthResId) {
        float designedWidth = view.getContext().getResources().getDimension(designedWidthResId);
    ...
    public static boolean setHeight(View view, int designedHeightResId) {
        if (view == null)
            return false;
        float designedHeight = view.getContext().getResources().getDimension(designedHeightResId);
        LayoutParams params = null;
        if (view instanceof ViewGroup)
            params = view.getLayoutParams();
        if (params == null)
    ...
    public static boolean setTextSize(TextView view, int designedTextSizeResId) {
        if (view == null)
            return false;
        float designedSize = view.getContext().getResources().getDimension(designedTextSizeResId);
     ...
     * @return
     */
    public static int computeScaledSize(Context context,float size) {

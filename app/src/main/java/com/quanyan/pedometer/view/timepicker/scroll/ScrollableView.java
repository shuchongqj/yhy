package com.quanyan.pedometer.view.timepicker.scroll;
...
import com.quanyan.pedometer.view.timepicker.base.BaseView;
import com.quanyan.pedometer.view.timepicker.utils.CollectionUtil;
...
public class ScrollableView extends BaseView {
    ...
    protected void onInit() {
        ...
        mScrollState = new ScrollState(getContext());
    }
    ...
    protected void setInterpolator(Interpolator interpolator) {
        mScrollState = new ScrollState(getContext() ,interpolator);
    }

...
package com.quanyan.base.view.customview.tabscrollindicator;
...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		mTextColor = getResources().getColorStateList(R.color.tv_orange_black_selected);
	...
	public void setTabViewTextSizeSp(int textSizeSp){
		TAB_VIEW_TEXT_SIZE_SP = textSizeSp;
	}
	...
	public void setOnTabClickListener(TabClick onTabClickListener){
		this.mTabClick = onTabClickListener;
	}
	public void setOnTabClickListener(TabClick onTabClickListener,boolean isJump){
		this.mTabClick = onTabClickListener;
		this.isJump=isJump;
	}
	/**
...
//		textView.setTypeface(Typeface.SERIF);
		if (!mDistributeEvenly) {
			...
			int width = displayMetrics.widthPixels / mViewPager.getAdapter().getCount();
			textView.setLayoutParams(new LinearLayout.LayoutParams(

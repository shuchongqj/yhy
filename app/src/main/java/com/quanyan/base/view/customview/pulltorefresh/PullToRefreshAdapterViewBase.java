...
import com.quanyan.base.view.customview.pulltorefresh.internal.IndicatorLayout;
    ...
    private boolean isFirstItemVisible() {
        ...
        if (null == adapter || adapter.isEmpty()) {
            ...
            if(mRefreshableView instanceof ListView){
                ...
                View childAt = mRefreshableView.getChildAt(0);
                if(lv.getFirstVisiblePosition() == 0 && childAt != null && childAt.getTop() == 0){
                    return true;
                }else{
                    return false;
                }
    ...
    private boolean isLastItemVisible() {
        ...
        if (null == adapter || adapter.isEmpty()) {
            if (DEBUG) {
                ...
                final int childIndex = mRefreshableView.getLastVisiblePosition()

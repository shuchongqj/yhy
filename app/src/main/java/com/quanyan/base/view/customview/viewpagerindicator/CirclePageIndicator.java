 ...
 */
package com.quanyan.base.view.customview.viewpagerindicator;
...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final float defaultIntervalDot = res
                .getDimension(R.dimen.default_circle_indicator_intervalDot);
        ...
        mIntervalDot = a.getDimension(R.styleable.CirclePageIndicator_intervalDot,
                defaultIntervalDot);
...
//        final int count = mViewPager.getAdapter().getCount();
        final int count = isInfiniteLoop ? mCount : mViewPager.getAdapter().getCount();
        if (count == 0 || count == 1) {
            return;
        }
        ...
        final float threeRadius = mRadius * 3 + mIntervalDot;
...
//        if ((mViewPager == null) || (mViewPager.getAdapter().getCount() == 0)) {
        if ((mViewPager == null) || ((isInfiniteLoop ? mCount : mViewPager.getAdapter().getCount()) == 0)) {
            return false;
        }
...
//                        mViewPager.setCurrentItem(mCurrentPage - 1);
                    	//2014/8/29 by xiezhidong for Loop
                    }
                    return true;
...
//                        mViewPager.setCurrentItem(mCurrentPage + 1);
    ...
    public void setCurrentItem(int position) {
        ...
        mCurrentPage = isInfiniteLoop ? position % mCount : position;
        invalidate();
    }
    ...
    public void onPageScrolled(int position, float positionOffset,
        ...
        if (mListener != null) {
            mListener.onPageScrolled(isInfiniteLoop ? position % mCount : position, positionOffset,
    ...
    public void onPageSelected(int position) {
        if (mSnap || mScrollState == ViewPager.SCROLL_STATE_IDLE) {
            mCurrentPage = isInfiniteLoop ? position % mCount : position;
            mSnapPage = isInfiniteLoop ? position % mCount : position;
            invalidate();
        }

        if (mListener != null) {
            mListener.onPageSelected(isInfiniteLoop ? position % mCount : position);
        }
    }
...
//            final int count = mViewPager.getAdapter().getCount();
	...
	/** 
	 * @Description  //2014/8/29 by xiezhidong for Loop

...
public class CircleDetailCommentAdapter extends BaseQuickAdapter<CommentInfo, BaseViewHolder> {
    ...
    public CircleDetailCommentAdapter(Activity activity, List<CommentInfo> data) {
        super(R.layout.cell_live_detail_comment, data);
        mActivity = activity;
    }
...
//                    R.mipmap.icon_default_avatar);
            ImageLoadManager.loadCircleImage(CommonUtil.getImageFullUrl(item.createUserInfo.avatar), R.mipmap.icon_default_avatar, helper.getView(R.id.cell_live_detail_comment_user_head));

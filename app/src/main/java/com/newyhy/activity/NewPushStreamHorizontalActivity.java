...
public class NewPushStreamHorizontalActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_push_stream_horizontal_activity);
    ...
    private void initPusher() {
        ...
        mPublisher.setPushOrientation(TXLiveConstants.VIDEO_ANGLE_HOME_RIGHT);
    ...
    LiveChatServiceConnector mConnector = new LiveChatServiceConnector() {
        ...
        public void onIMServiceConnected(LiveChatService chatService) {
            ...
            if (chatService == null || liveId == 0) {
                ToastUtil.showToast(NewPushStreamHorizontalActivity.this, "create live error");
                finish();
                return;
            }

            mChatService = chatService;
            EventBus.getDefault().register(NewPushStreamHorizontalActivity.this);
        ...
        public void onServiceDisconnected() {
            isConnector = false;
            if (EventBus.getDefault().isRegistered(NewPushStreamHorizontalActivity.this)) {
                EventBus.getDefault().unregister(NewPushStreamHorizontalActivity.this);
            }
        }
    };
    ...
    private void shareLayoutConfig() {
        ...
        behind_start_live_share_wx_friends.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!behind_start_live_share_wx_friends.isSelected())
                    behindStartLiveShareIndex = -1;
            }
        });
...
//        Bitmap logoBm = BitmapFactory.decodeResource(getResources(), R.mipmap.app_logo_share);
        ...
        web.setThumb(new UMImage(this, CommonUtil.getImageFullUrl(SPUtils.getUserIcon(this))));  //缩略图
        ...
        if (position == 0) {
            ...
            //新浪微博
            ShareAction shareAction = new ShareAction(NewPushStreamHorizontalActivity.this);
            shareAction
                    .setCallback(umShareListener)
                    .setPlatform(SHARE_MEDIA.SINA)
                    .withMedia(new UMImage(this, CommonUtil.getImageFullUrl(SPUtils.getUserIcon(this))))
...
//        View contentView = View.inflate(this, R.layout.push_share_content, null);
//        contentView.findViewById(R.id.push_pop_share_wechat).setOnClickListener(this);
//        contentView.findViewById(R.id.push_pop_share_wechat_circle).setOnClickListener(this);
//        contentView.findViewById(R.id.push_pop_share_qq_layout).setOnClickListener(this);
//        contentView.findViewById(R.id.push_pop_share_sina_layout).setOnClickListener(this);
//        contentView.findViewById(R.id.stream_push_pop_share_parent_viewgroup).setOnClickListener(this);
//        mPopView = new PopView(this, contentView, R.style.pushsharepopanim, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
//        mPopView.showPopView(v);
//        jumpToShare("[直播] 来我直播间一起high！", "(" + SPUtils.getNickName(this) + ")我开播了!,来我的直播间围观吧~", 0);
        ...
        switch (v.getId()) {
            ...
            case R.id.ib_flash_light:
                if (openFlash) {
                    ...
                    mPublisher.turnOnFlash(openFlash);
                } else {
...
//                mVideoRootView.stopPusher();
                ...
                mLiveController.closeLive(NewPushStreamHorizontalActivity.this, mHandler, liveId);
                if (closeLiveDialog != null && closeLiveDialog.isShowing()) {
                    closeLiveDialog.dismiss();
                }
            }

...
public class CircleNewsNoPicLayout extends LinearLayout {
    ...
    public CircleNewsNoPicLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initViews(context);
    }

    public CircleNewsNoPicLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

...
public class CircleNews3PicLayout extends LinearLayout {
    ...
    public CircleNews3PicLayout(Context context) {
        super(context);
        initViews(context);
    }

    public CircleNews3PicLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initViews(context);
    }

    public CircleNews3PicLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initViews(context);
    }

    public void initViews(Context context) {
        LayoutInflater.from(context).inflate(R.layout.circle_news_3pic_layout, this);
        ...
        iv_cover1 = findViewById(R.id.iv_1);
        iv_cover2 = findViewById(R.id.iv_2);
        iv_cover3 = findViewById(R.id.iv_3);
        more_pic = findViewById(R.id.more_pic);
    }
    ...
    public <T> void setData(Context context, T data) {
        ...
        //image1
        if (picList != null && picList.get(0) != null && !picList.get(0).equals(iv_cover1.getTag(R.id.iv_1))) {
            iv_cover1.setTag(R.id.iv_1, picList.get(0));
            ImageLoadManager.loadImage(CommonUtil.getImageFullUrl(picList.get(0)), R.mipmap.icon_default_310_180, iv_cover1, 3, true);
        }

        //image2
        if (picList != null && picList.get(1) != null && !picList.get(1).equals(iv_cover2.getTag(R.id.iv_2))) {
            iv_cover2.setTag(R.id.iv_2, picList.get(1));
            ImageLoadManager.loadImage(CommonUtil.getImageFullUrl(picList.get(1)), R.mipmap.icon_default_310_180, iv_cover2, 3, true);
        }

        //image3
        if (picList != null && picList.get(2) != null && !picList.get(2).equals(iv_cover3.getTag(R.id.iv_3))) {
            iv_cover3.setTag(R.id.iv_3, picList.get(2));
            ImageLoadManager.loadImage(CommonUtil.getImageFullUrl(picList.get(2)), R.mipmap.icon_default_310_180, iv_cover3, 3, true);
        }

        if (picList != null && picList.size() > 3) {
            more_pic.setVisibility(VISIBLE);
        } else {
            more_pic.setVisibility(GONE);
        }

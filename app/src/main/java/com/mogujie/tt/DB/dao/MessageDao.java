...
public class MessageDao extends AbstractDao<MessageEntity, Long> {
    ...
    public static class Properties {
        ...
        public final static Property FromId = new Property(2, long.class, "fromId", false, "FROM_ID");
        public final static Property ToId = new Property(3, long.class, "toId", false, "TO_ID");
        ...
        public final static Property ServiceId = new Property(11, int.class, "serviceId", false, "SERVICEID");
    }
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'Message' (" + //
                ...
                "'FROM_ID' LONG NOT NULL ," + // 2: fromId
                "'TO_ID' LONG NOT NULL ," + // 3: toId
                ...
                "'SERVICEID' INTEGER DEFAULT 0);"); // 10: updated
        // Add Indexes
    ...
    protected void bindValues(SQLiteStatement stmt, MessageEntity entity) {
        ...
        stmt.bindLong(12, entity.getServiceId());
    }
    ...
    public MessageEntity readEntity(Cursor cursor, int offset) {
        MessageEntity entity = new MessageEntity( //
                ...
                cursor.getLong(offset + 2), // fromId
                cursor.getLong(offset + 3), // toId
    ...
    public void readEntity(Cursor cursor, MessageEntity entity, int offset) {
        ...
        entity.setFromId(cursor.getLong(offset + 2));
        entity.setToId(cursor.getLong(offset + 3));
        ...
        entity.setServiceId(cursor.getInt(offset + 11));
    }

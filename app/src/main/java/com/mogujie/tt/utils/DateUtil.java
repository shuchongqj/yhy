...
public class DateUtil {
    ...
    public static String getTimeDiffDesc(Date date) {
        ...
        if (thenCalendar.after(today) && thenCalendar.before(tomorrow))// today
        {
            ...
            if (thenYear != todayYear) {
                strDesc = thenYear + "年";
            } else {
                strDesc = "";
            }
            if (h < 6) {
                strDesc = strDesc + (thenMonth + 1) + "月" + thenDay + "日" + "凌晨 " + sh
                        + h + ":" + sm + m;
            } else if (h < 12) {
                strDesc = strDesc + (thenMonth + 1) + "月" + thenDay + "日" + "上午 " + sh
                        + h + ":" + sm + m;
            } else if (h < 13) {
                strDesc = strDesc + (thenMonth + 1) + "月" + thenDay + "日" + "下午 " + h
                        + ":" + sm + m;
            } else if (h < 19) {
                strDesc = strDesc + (thenMonth + 1) + "月" + thenDay + "日" + "下午 "
                        + (h - 12) + ":" + sm + m;
            } else {
                strDesc = strDesc + (thenMonth + 1) + "月" + thenDay + "日" + "晚上 "
                        + (h - 12) + ":" + sm + m;
            }
        }
     ...
     * @return
     */
    public static boolean isWorkTime(int startHour,int endHour){

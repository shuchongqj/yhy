...
public abstract class BaseMsgRenderView extends RelativeLayout {
    ...
    public void render(final MessageEntity entity, UserEntity userEntity, final Context ctx) {
        ...
        //头像设置
        portrait.setDefaultImageRes(R.mipmap.icon_default_avatar);
...
//            name.setText(userEntity.getMainName());
        ...
        final long userId = userEntity.getPeerId();
        final String userNick = userEntity.getMainName();
        final long options = userEntity.getOptions();
        portrait.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                NavUtils.gotoPersonalPage(ctx, userId, userNick, options);
            }
        });
        /**头像事件 end*/

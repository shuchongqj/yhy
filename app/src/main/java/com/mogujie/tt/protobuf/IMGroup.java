...
public final class IMGroup {
  ...
  public static final class IMGroupCreateRsp extends
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < userIdList_.size(); i++) {
        output.writeUInt64(5, userIdList_.get(i));
      }
      if (((bitField0_ & 0x00000010) == 0x00000010)) {
        output.writeBytes(20, attachData_);
      }
  ...
  public static final class IMGroupChangeMemberReq extends
          ...
          switch (tag) {
            ...
            case 32: {
              if (!((mutable_bitField0_ & 0x00000008) == 0x00000008)) {
                memberIdList_ = new java.util.ArrayList<java.lang.Long>();
                mutable_bitField0_ |= 0x00000008;
              }
              memberIdList_.add(input.readUInt64());
              break;
            }
            case 34: {
              int length = input.readRawVarint32();
    ...
    private java.util.List<java.lang.Long> memberIdList_;
    /**
     * <code>repeated uint64 member_id_list = 4;</code>
     */
    public java.util.List<java.lang.Long>
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < memberIdList_.size(); i++) {
        output.writeUInt64(4, memberIdList_.get(i));
      }
      if (((bitField0_ & 0x00000008) == 0x00000008)) {
        output.writeBytes(20, attachData_);
      }
    ...
    public int getSerializedSize() {
      ...
      }
      {
        ...
        for (int i = 0; i < memberIdList_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt64SizeNoTag(memberIdList_.get(i));
        }
        size += dataSize;
        size += 1 * getMemberIdListList().size();
      }
    ...
    public static final class Builder extends
      ...
      private java.util.List<java.lang.Long> memberIdList_ = java.util.Collections.emptyList();
      private void ensureMemberIdListIsMutable() {
        if (!((bitField0_ & 0x00000008) == 0x00000008)) {
          memberIdList_ = new java.util.ArrayList<java.lang.Long>(memberIdList_);
          bitField0_ |= 0x00000008;
         }
      }
      /**
  ...
  public static final class IMGroupChangeMemberRsp extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 40: {
              if (!((mutable_bitField0_ & 0x00000010) == 0x00000010)) {
                curUserIdList_ = new java.util.ArrayList<java.lang.Long>();
                mutable_bitField0_ |= 0x00000010;
              }
              curUserIdList_.add(input.readUInt64());
              break;
            }
            case 42: {
              int length = input.readRawVarint32();
            ...
            case 48: {
              if (!((mutable_bitField0_ & 0x00000020) == 0x00000020)) {
                chgUserIdList_ = new java.util.ArrayList<java.lang.Long>();
                mutable_bitField0_ |= 0x00000020;
              }
              chgUserIdList_.add(input.readUInt64());
              break;
            }
            case 50: {
              int length = input.readRawVarint32();
    ...
    private java.util.List<java.lang.Long> curUserIdList_;
    /**
     * <code>repeated uint64 cur_user_id_list = 5;</code>
     *
     * <pre>
    ...
    private java.util.List<java.lang.Long> chgUserIdList_;
    /**
     * <code>repeated uint64 chg_user_id_list = 6;</code>
     *
     * <pre>
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < curUserIdList_.size(); i++) {
        output.writeUInt64(5, curUserIdList_.get(i));
      }
      for (int i = 0; i < chgUserIdList_.size(); i++) {
        output.writeUInt64(6, chgUserIdList_.get(i));
      }
      if (((bitField0_ & 0x00000010) == 0x00000010)) {
        output.writeBytes(20, attachData_);
      }
    ...
    public int getSerializedSize() {
      ...
      }
      {
        ...
        for (int i = 0; i < curUserIdList_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt64SizeNoTag(curUserIdList_.get(i));
        }
        size += dataSize;
      ...
      }
      {
        ...
        for (int i = 0; i < chgUserIdList_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt64SizeNoTag(chgUserIdList_.get(i));
        }
        size += dataSize;
    ...
    public static final class Builder extends
      ...
      private java.util.List<java.lang.Long> curUserIdList_ = java.util.Collections.emptyList();
      private void ensureCurUserIdListIsMutable() {
        if (!((bitField0_ & 0x00000010) == 0x00000010)) {
          curUserIdList_ = new java.util.ArrayList<java.lang.Long>(curUserIdList_);
          bitField0_ |= 0x00000010;
         }
      }
      /**
      ...
      private java.util.List<java.lang.Long> chgUserIdList_ = java.util.Collections.emptyList();
      private void ensureChgUserIdListIsMutable() {
        if (!((bitField0_ & 0x00000020) == 0x00000020)) {
          chgUserIdList_ = new java.util.ArrayList<java.lang.Long>(chgUserIdList_);
          bitField0_ |= 0x00000020;
         }
      }
      /**
  ...
  public static final class IMGroupChangeMemberNotify extends
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < curUserIdList_.size(); i++) {
        output.writeUInt64(4, curUserIdList_.get(i));
      }
      for (int i = 0; i < chgUserIdList_.size(); i++) {
        output.writeUInt64(5, chgUserIdList_.get(i));
      }
      output.writeRawBytes(unknownFields);
    }

...
public class WsyUtils {
    ...
    private static String bucketName = YHYBaseApplication.getInstance().getYhyEnvironment().isOnline()?"qywlkj":"qywlkj-test001";
    ...
    private static String getPutPolicyJson() {
        ...
        String result = JSONUtils.toJson(putPolicy);
        return result;
    }

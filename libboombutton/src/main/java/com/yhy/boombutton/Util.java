...
public class Util {
    ...
    private static final int[] colors = new int[] {
            Color.parseColor("#37b591"),
            Color.parseColor("#f5a518"),
            Color.parseColor("#e95578"),
            Color.parseColor("#3aa7df"),
            Color.parseColor("#e95578"),
            Color.parseColor("#3aa7df"),
            Color.parseColor("#37b592"),
            Color.parseColor("#f5a518"),
    };
    ...
    public static int getColor() {
        for (int colorIndex = 0; colorIndex < colors.length; colorIndex++) {
            if (usedColor.size() == colors.length) {
                usedColor.clear();
            }
    ...
    public static int getDarkColor() {
        return Util.getDarkerColor(usedColor.get(usedColor.size() - 1));
    }

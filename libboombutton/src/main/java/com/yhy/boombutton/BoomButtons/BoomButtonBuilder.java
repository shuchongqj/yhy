package com.yhy.boombutton.BoomButtons;
...
import com.yhy.boombutton.Piece.BoomPiece;
...
public abstract class BoomButtonBuilder<T> {
    ...
    int shadowOffsetY = Util.dp2px(0);
    int shadowRadius = Util.dp2px(0);
    int shadowColor = Color.parseColor("#00000000");
    int shadowCornerRadius = Util.dp2px(0);
    ...
    Rect imageRect = new Rect(Util.dp2px(4), Util.dp2px(4), Util.dp2px(52), Util.dp2px(52));
    ...
    int highlightedTextColor = Color.GRAY;
    int highlightedTextColorRes = 0;
    int unableTextColor = Color.GRAY;
    ...
    int highlightedColor = Util.getDarkerColor(normalColor);
    int highlightedColorRes = Color.TRANSPARENT;
    int unableColor = Util.getDarkerColor(normalColor);
    int unableColorRes = Color.TRANSPARENT;
    boolean unable = false;
    int buttonRadius = Util.dp2px(28);

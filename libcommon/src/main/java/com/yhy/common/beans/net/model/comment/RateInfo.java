...
public class RateInfo implements Serializable{
    ...
    private static final long serialVersionUID = 268175608764021265L;
    /**
     * 用户信息
     */
     ...
     */
    public static RateInfo deserialize(String json) throws JSONException {
     ...
     */
    public static RateInfo deserialize(JSONObject json) throws JSONException {
        if (json != null && json != JSONObject.NULL && json.length() > 0) {
            RateInfo result = new RateInfo();
          ...
          if(!picListArray.isNull(i)){
            ...
            // 回复时间
            result.backTime = json.optLong("backTime");
            // 回复内容

            if(!json.isNull("backContent")){
                result.backContent = json.optString("backContent", null);
            }
    ...
    public JSONObject serialize() throws JSONException {
        ...
        // 回复时间
        json.put("backTime", this.backTime);

        // 回复内容
        if(this.backContent != null) { json.put("backContent", this.backContent); }

...
public class SelectCartInfo implements Serializable {
    private static final long serialVersionUID = 600448491294117514L;
     ...
     */
    public static SelectCartInfo deserialize(String json) throws JSONException {
     ...
     */
    public static SelectCartInfo deserialize(JSONObject json) throws JSONException {
        if (json != null && json != JSONObject.NULL && json.length() > 0) {
            SelectCartInfo result = new SelectCartInfo();

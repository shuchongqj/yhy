...
public class MessageEntity implements java.io.Serializable {
    ...
    public MessageEntity(Long id, int msgId, long fromId, long toId, String sessionKey, String content, int msgType, int displayType, int status, int created, int updated,int serviceId) {
        this.id = id;
        this.msgId = msgId;
        this.fromId = fromId;
        this.toId = toId;
    ...
    public int getSessionType() {
        switch (msgType) {
            ...
            case DBConstant.MSG_TYPE_CONSULT_KNOWLEDGE:
    ...
    public String getMessageDisplay() {
        switch (displayType) {
            ...
            case DBConstant.SHOW_PRODUCT_CARD_TYPE:
                return DBConstant.DISPlAY_FOR_PRODUCT_CARD;
            case DBConstant.SHOW_KNOWLEDGE_TYPE:
                return DBConstant.DISPLAY_FOR_KNOWLEDGE;
            case DBConstant.SHOW_NOTIFY:
                return content;
            default:
                return DBConstant.DISPLAY_FOR_UNKNOWN;
        }
    }
    ...
    public boolean isSend(long loginId) {

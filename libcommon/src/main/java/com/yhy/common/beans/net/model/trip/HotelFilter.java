...
public class HotelFilter implements Serializable{
    ...
    private static final long serialVersionUID = 6654809861011182471L;
    /**
     * 区域列表
     */
     ...
     */
    public static HotelFilter deserialize(String json) throws JSONException {
     ...
     */
    public static HotelFilter deserialize(JSONObject json) throws JSONException {
        if (json != null && json != JSONObject.NULL && json.length() > 0) {
            HotelFilter result = new HotelFilter();

...
public class RateInfoQuery implements Serializable {

    private static final long serialVersionUID = -6940081462106298249L;
    /**
     * id-景区酒店等
     */
    public long outId;
     ...
     */
    public static RateInfoQuery deserialize(String json) throws JSONException {
     ...
     */
    public static RateInfoQuery deserialize(JSONObject json) throws JSONException {
        if (json != null && json != JSONObject.NULL && json.length() > 0) {
            RateInfoQuery result = new RateInfoQuery();

...
public class PayCoreBaseResult implements Serializable {
    private static final long serialVersionUID = 9035897170434236427L;
     ...
     */
    public static PayCoreBaseResult deserialize(String json) throws JSONException {
     ...
     */
    public static PayCoreBaseResult deserialize(JSONObject json) throws JSONException {
        if (json != null && json != JSONObject.NULL && json.length() > 0) {
            PayCoreBaseResult result = new PayCoreBaseResult();

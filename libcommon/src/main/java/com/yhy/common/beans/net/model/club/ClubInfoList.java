...
public class ClubInfoList  implements Serializable {

    private static final long serialVersionUID = -4091119021787861908L;
    /**
     * 当前页码
     */
    public int pageNo;
     ...
     */
    public static ClubInfoList deserialize(String json) throws JSONException {
     ...
     */
    public static ClubInfoList deserialize(JSONObject json) throws JSONException {
        if (json != null && json != JSONObject.NULL && json.length() > 0) {
            ClubInfoList result = new ClubInfoList();

...
/**   
 * @Title: WalkDataInfos.java 
 * @Package: com.pajk.hm.sdk.android.entity 
 * @Description: TODO
 * @author xiezhidong@pajk.cn  
 * @date 2014-12-2 下午3:00:18 
 */
...
public class WalkDataInfos {
     ...
     */
    public static WalkDataInfos deserialize(JSONObject json) throws JSONException {
    ...
    public JSONObject serialize() throws JSONException {
        ...
        // 活动描述前缀
        if(this.activityPrefix != null) { json.put("activityPrefix", this.activityPrefix); }
          
        // 路程可兑换的钱
        json.put("money", this.money);
          
        // 活动描述后缀
        if(this.activitySuffix != null) { json.put("activitySuffix", this.activitySuffix); }

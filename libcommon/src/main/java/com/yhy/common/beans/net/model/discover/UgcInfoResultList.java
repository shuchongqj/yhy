 ...
 * Description:
 */
public class UgcInfoResultList implements Serializable{

    private static final long serialVersionUID = 3635910719473009769L;
    /**
     * 当前页码
     */
    public int pageNo;
     ...
     */
    public static UgcInfoResultList deserialize(String json) throws JSONException {
     ...
     */
    public static UgcInfoResultList deserialize(JSONObject json) throws JSONException {
        if (json != null && json != JSONObject.NULL && json.length() > 0) {
            UgcInfoResultList result = new UgcInfoResultList();

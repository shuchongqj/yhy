...
/**   
 * @Title: WalkDataInfoPerHour.java 
...
public class WalkDataInfoPerHour implements Serializable{
     ...
     */
    public static WalkDataInfo deserialize(JSONObject json) throws JSONException {
    ...
    public JSONObject serialize() throws JSONException {
        ...
        // 服务端记步日期yyyyMMdd
        if(this.walkDate != null) { json.put("walkDate", this.walkDate); }

...
public class RouteTrafficInfo implements Serializable{
     ...
     */
    public static RouteTrafficInfo deserialize(String json) throws JSONException {
     ...
     */
    public static RouteTrafficInfo deserialize(JSONObject json) throws JSONException {
        if (json != null && json != JSONObject.NULL && json.length() > 0) {
            RouteTrafficInfo result = new RouteTrafficInfo();

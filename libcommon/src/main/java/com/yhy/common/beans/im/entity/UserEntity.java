...
//    private int status;
    ...
    public UserEntity(Long id, long peerId, int gender, String mainName, String pinyinName, String realName, String avatar, int created, int updated, boolean isVip, int options) {
        this.id = id;
        this.peerId = peerId;
        this.gender = gender;
...
//                ", searchElement=" + searchElement +
    ...
    public boolean equals(Object o) {
        ...
        if (pinyinName != null ? !pinyinName.equals(entity.pinyinName) : entity.pinyinName != null)
            return false;
        return !(realName != null ? !realName.equals(entity.realName) : entity.realName != null);

    }

    @Override
    public int hashCode() {
        int result = (int)peerId;

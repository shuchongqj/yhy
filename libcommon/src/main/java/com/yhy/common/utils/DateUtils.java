...
//        return yearNow - yearBirthday > 0 ? (yearNow - yearBirthday ) : 0;
    ...
    public static boolean isPast(long t) {
        return t < DateUtils.getDayStartTimer(System.currentTimeMillis());
    }
    ...
    public static boolean isFuture(long t) {
        return t > DateUtils.getDayEndTimer(System.currentTimeMillis());
    }
    ...
    public static String getNDayDate(int n) {
        Date date = new Date();
        SimpleDateFormat sf = new SimpleDateFormat(DateUtils.getTodayDate("yyyy-MM-dd"));
    ...
    public static String differDay(long timeStart, long timeEnd) {
        String str1 = DateUtils.convert2String(timeStart, "yyyMMdd");//"yyyyMMdd"格式 如 20131022
        String str2 = DateUtils.convert2String(timeEnd, "yyyMMdd");//"yyyyMMdd"格式 如 20131022
    ...
    public static List<Date> getAllDifferDays(long startTime, long endTime, String format) {
        String str1 = DateUtils.convert2String(startTime, format);//"yyyyMMdd"格式 如 20131022
        String str2 = DateUtils.convert2String(endTime, format);//"yyyyMMdd"格式 如 20131022
